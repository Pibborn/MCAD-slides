...
\begin{frame}{Asynchronous Floodmax}{OptFloodMax}
    ...
    \vspace{12pt}
    There is a simple optimization that can be used to reduce the number of messages sent. The processes can propagate the maximum UID only when they first learn about it, instead of doing so each round.
    \vspace{12pt}
